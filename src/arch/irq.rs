...
pub fn setup() {
    ...
    idt.set_descriptor(
        ...
        Descriptor::new()
            .set_handler_addr(clock_tick as u64)
            .set_options(flags)
            .build(),
    );
}
...
pub extern "C" fn clock_tick_handler(state: x86_64::cpu::State) {
...
interrupt_handler!(crate::config::IRQ_BASE, clock_tick, clock_tick_handler, 0);
